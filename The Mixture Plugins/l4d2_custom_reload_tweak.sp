...
public OnPluginStart()
{
	...
	hCvarReloadSpeedRifleAK = CreateConVar("l4d2_reload_speed_rifle_ak", "0", "Reload duration of AK", FCVAR_CHEAT|FCVAR_NOTIFY, true, 0.0, true, 10.0);
	hCvarReloadSpeedRifleSG = CreateConVar("l4d2_reload_speed_rifle_sg", "0", "Reload duration of SG552", FCVAR_CHEAT|FCVAR_NOTIFY, true, 0.0, true, 10.0);
	...
	hCvarReloadSpeedSniperScout = CreateConVar("l4d2_reload_speed_scout", "0", "Reload duration of Souct", FCVAR_CHEAT|FCVAR_NOTIFY, true, 0.0, true, 10.0);
	hCvarReloadSpeedSniperAWP = CreateConVar("l4d2_reload_speed_awp", "0", "Reload duration of AWP", FCVAR_CHEAT|FCVAR_NOTIFY, true, 0.0, true, 10.0);
	hCvarReloadSpeedRifleM60 = CreateConVar("l4d2_reload_speed_m60", "0", "Reload duration of M60", FCVAR_CHEAT|FCVAR_NOTIFY, true, 0.0, true, 10.0);
	hCvarReloadSpeedSniperHR = CreateConVar("l4d2_reload_speed_hr", "0", "Reload duration of HR", FCVAR_CHEAT|FCVAR_NOTIFY, true, 0.0, true, 10.0);
