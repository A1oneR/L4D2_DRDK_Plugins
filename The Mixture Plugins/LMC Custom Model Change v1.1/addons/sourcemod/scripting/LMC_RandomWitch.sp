...
#define MODEL_1			"models/infected/kcboatslutkashima.mdl"
#define MODEL_2			"models/infected/kcboatslutyuudachi.mdl"
#define MODEL_3			"models/infected/kcboatslutshitkaze.mdl"
...
static g_iRandomWitchChance = 100;
...
public OnPluginStart()
{
	...
	hCvar_RandomWitchChance = CreateConVar("lmc_randomwitchchance", "100", "Chance out of 100 to have a overlay model, (0, 100)", FCVAR_NOTIFY, true, 0.0, true, 100.0);
